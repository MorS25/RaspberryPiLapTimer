...
var decode = function(val) {
	...
	for(var i=1;i<5;i++)
	{
		if(val[i] > 2000 && val[i] < 3000)
		{
			ret += Math.pow(2, i-1);
			// s+= "1";
		}
		else if(val[i] > 1000 && val[i] < 2000)
		{
			// s+="0";
		}
		else
	...
	var decodedVal = Math.floor(ret);
	if(allowed_codes[decodedVal])
	{
		return decodedVal
	}
	else
...
var header_space = 5000;  // 1000 micro seconds header space
var prev_pulse = 0;
var pulse = [];
